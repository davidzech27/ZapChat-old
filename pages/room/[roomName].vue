...
<div v-if="room.isLoaded && room.exists" class="grid grid-cols-3">
    ...
    <div v-show="editRoomPopup" class="absolute h-screen w-screen bg-background bg-opacity-75 backdrop-filter backdrop-blur-md flex justify-center items-center z-10">
...
<div v-else-if="!room.exists" class="h-screen flex justify-center pt-72 px-24
